...
<body>
    ...
    <main class="main">
        ...
        <section class="content">
            <h2 class="page__title"><span class="icon material-icons">trending_flat</span>Остаток</h2>
            <div class="container_table">
                <div class="table__col active" id="table_balance-wrap">
                    <table class="display" id="table_balance">
                        <tbody id="tbody_balance"></tbody>
                    </table>
                </div>
            </div>
        </section>
