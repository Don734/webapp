    ...
    <main class="main">
        ...
        <section class="content">
            <div class="container_table">
                <button class="add" id="addProject">Добавить</button>
                <div class="table__col active" id="table_id-wrap">
                    <table class="display" id="table_id">
                        <tbody id="tbody_tableid"></tbody>
                    </table>
                </div>
            </div>
        </section>
        <?php include_once './inc/modalPrizma.php'; ?>
    </main>
